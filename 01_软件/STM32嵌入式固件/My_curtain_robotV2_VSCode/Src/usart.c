...
void HAL_GPIO_EXTI_Callback(uint16_t GPIO_Pin)
{
    ...
    {
        //�����﻽��
		HAL_UART_MspInit(&huart2); //��ʼ�� ����  ��һ���ᶪʧ��������΢��С����Э����
...
void EnableUsart_IT(void)
{
    ...
    __HAL_UART_ENABLE_IT(&huart2, UART_IT_IDLE); //��������2���н����ж�
    __HAL_UART_CLEAR_IDLEFLAG(&huart2);          //�������2�����жϱ�־λ
    HAL_UART_Receive_DMA(&huart2,Usart2type.Usart2DMARecBuffer,USART2_DMA_REC_SIE);  //ʹ��DMA����
}
