...
void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, NSLEEP_Pin|N_IN1_Pin|N_IN2_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : BT_RST_Pin BT_EN_Pin */
  ...
  /*Configure GPIO pins : NSLEEP_Pin N_IN1_Pin N_IN2_Pin */
  GPIO_InitStruct.Pin = NSLEEP_Pin|N_IN1_Pin|N_IN2_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(GPIOB, &GPIO_InitStruct);
